data "aws_iam_policy_document" "cluster_autoscaler_assume_role_policy" {
  statement {
    ...
    condition {
      ...
      values   = ["system:serviceaccount:kube-system:cluster_autoscaler"]
    }
...
resource "aws_iam_role" "cluster_autoscaler" {
  ...
  name               = "${var.cluster_name}-cluster_autoscaler-role"
}

resource "aws_iam_policy" "cluster_autoscaler" {
  name = "${var.cluster_name}-cluster_autoscaler-policy"
